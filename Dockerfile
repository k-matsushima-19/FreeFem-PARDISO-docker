...
RUN wget https://github.com/FreeFem/FreeFem-sources/archive/refs/tags/v4.15.tar.gz && tar xf v4.15.tar.gz
WORKDIR /usr/local/src/FreeFem-sources-4.15
...
WORKDIR /usr/local/src/FreeFem-sources-4.15/3rdparty/ff-petsc
